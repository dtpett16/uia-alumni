		...
		public function render_content() {
			...
			echo '
				<div class="bnt-customizer-help">
					<a class="bnt-customizer-link bnt-support-link" href="http://www.ilovewp.com/documentation/edupress/" target="_blank">
					...
					<a class="bnt-customizer-link bnt-rate-link" href="https://wordpress.org/support/theme/edupress/reviews/" target="_blank">
						...
						'.esc_html__( 'Rate Edupress (thanks!)', 'edupress' ).'
					</a>
					<a class="bnt-customizer-link bnt-ep-link" href="http://eepurl.com/cvTvUL" target="_blank">
						...
						'.esc_html__( 'Subscribe to our Newsletter', 'edupress' ).'
					</a>
				</div>
			';
		}
